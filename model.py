...
from torch_geometric.nn import global_max_pool, FiLMConv,GATConv,global_mean_pool, GCNConv,global_sum_pool
...
class GraphNetwork(torch.nn.Module):
    ...
    def forward(self, x, edge_index, edge_type, graph_batch):
        ...
        sum_features = global_sum_pool(features, graph_batch)
        hidden = F.relu(self.linear(self.dropout(torch.cat([max_features, sum_features], dim=-1))))
